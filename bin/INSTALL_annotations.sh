...
curl -C - -LO https://www.lbgi.fr/~geoffroy/Annotations/Annotations_Human_3.3.5.tar.gz
tar -xf Annotations_Human_3.3.5.tar.gz -C .
rm -rf Annotations_Human_3.3.5.tar.gz
