...
pid=$$
$ANNOTSV/bin/AnnotSV -SVinputFile "$SVinputFile" -SVinputInfo 1 -snvIndelFiles "$SNVindelInputFile" -outputFile ./output/HG00096.SV_tcl.annotated.tsv -genomeBuild GRCh37 &> tutu.$pid.log 
