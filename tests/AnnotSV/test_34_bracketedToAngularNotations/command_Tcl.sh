...
squareResult=`$cut "./output/command_1_square-bracketed-del_1.annotated.tsv" "AnnotSV_ID;ID;SV_chrom;SV_start;SV_end;SV_type;REF;ALT;ACMG_class" | tail -1 | awk 'BEGIN{ORS=" "; OFS=" "} { print $1, $2, $3, $4, $5, $6, $7, $8, $9}'`
if [ "$squareResult" != "12_3000_5000_DEL_1 breakend_del_1_a 12 3000 5000 DEL T T[12:5000[ 3 " ]
then
...
angleResult=`$cut "./output/command_1_angle-bracketed-del_1.annotated.tsv" "AnnotSV_ID;ID;SV_chrom;SV_start;SV_end;SV_type;REF;ALT;ACMG_class" | tail -1 | awk 'BEGIN{ORS=" "; OFS=" "} { print $1, $2, $3, $4, $5, $6, $7, $8, $9}'`
if [ "$angleResult" != "12_3000_5000_DEL_1 breakend_del_1_a 12 3000 5000 DEL T <DEL> 3 " ]
then
...
BEDresult=`$cut "./output/command_1_BED-del_1.annotated.tsv" "AnnotSV_ID;SV_chrom;SV_start;SV_end;SV_type;ACMG_class" | tail -1 | awk 'BEGIN{ORS=" "; OFS=" "} { print $1, $2, $3, $4, $5, $6}'`
if [ "$BEDresult" != "12_3000_5000_DEL_1 12 3000 5000 DEL 3 " ]
then
...
squareResult=`$cut "./output/command_2_square-bracketed-del_partial_pass.annotated.tsv" "AnnotSV_ID;ID;SV_chrom;SV_start;SV_end;SV_type;REF;ALT;ACMG_class" | tail -1 | awk 'BEGIN{ORS=" "; OFS=" "} { print $1, $2, $3, $4, $5, $6, $7, $8, $9}'`
if [ "$squareResult" != "15_3000_5000_DEL_1 breakend_del_partial_pass_b 15 3000 5000 DEL T T[15:5000[ 3 " ]
then
...
angleResult=`$cut "./output/command_2_angle-bracketed-del_partial_pass.annotated.tsv" "AnnotSV_ID;ID;SV_chrom;SV_start;SV_end;SV_type;REF;ALT;ACMG_class" | tail -1 | awk 'BEGIN{ORS=" "; OFS=" "} { print $1, $2, $3, $4, $5, $6, $7, $8, $9}'`
if [ "$angleResult" != "15_3000_5000_DEL_1 breakend_del_partial_pass_b 15 3000 5000 DEL T <DEL> 3 " ]
then
...
BEDresult=`$cut "./output/command_2_BED-del_partial_pass.annotated.tsv" "AnnotSV_ID;SV_chrom;SV_start;SV_end;SV_type;ACMG_class" | tail -1 | awk 'BEGIN{ORS=" "; OFS=" "} { print $1, $2, $3, $4, $5, $6}'`
if [ "$BEDresult" != "15_3000_5000_DEL_1 15 3000 5000 DEL 3 " ]
then
...
squareResult=`$cut "./output/command_3_square-bracketed-del_unordered.annotated.tsv" "AnnotSV_ID;ID;SV_chrom;SV_start;SV_end;SV_type;REF;ALT;ACMG_class" | tail -1 | awk 'BEGIN{ORS=" "; OFS=" "} { print $1, $2, $3, $4, $5, $6, $7, $8, $9}'`
if [ "$squareResult" != "22_3000_5000_DEL_1 breakend_del_unordered_a 22 3000 5000 DEL T T[22:5000[ 3 " ]
then
...
squareResult=`$cut "./output/command_4_square-bracketed-dup.annotated.tsv" "AnnotSV_ID;ID;SV_chrom;SV_start;SV_end;SV_type;REF;ALT;ACMG_class" | tail -1 | awk 'BEGIN{ORS=" "; OFS=" "} { print $1, $2, $3, $4, $5, $6, $7, $8, $9}'`
if [ "$squareResult" != "2_3000_5000_DUP_1 breakend_dup_a 2 3000 5000 DUP T ]2:5000]T 3 " ]
then
...
angleResult=`$cut "./output/command_4_angle-bracketed-dup.annotated.tsv" "AnnotSV_ID;ID;SV_chrom;SV_start;SV_end;SV_type;REF;ALT;ACMG_class" | tail -1 | awk 'BEGIN{ORS=" "; OFS=" "} { print $1, $2, $3, $4, $5, $6, $7, $8, $9}'`
if [ "$angleResult" != "2_3000_5000_DUP_1 breakend_dup_a 2 3000 5000 DUP T <DUP> 3 " ]
then
...
BEDresult=`$cut "./output/command_4_BED-dup.annotated.tsv" "AnnotSV_ID;SV_chrom;SV_start;SV_end;SV_type;ACMG_class" | tail -1 | awk 'BEGIN{ORS=" "; OFS=" "} { print $1, $2, $3, $4, $5, $6}'`
if [ "$BEDresult" != "2_3000_5000_DUP_1 2 3000 5000 DUP 3 " ]
then
...
BEDresult=`$cut "./output/command_5_BED-empty_del.annotated.tsv" "AnnotSV_ID;SV_chrom;SV_start;SV_end;SV_type;ACMG_class" | tail -1 | awk 'BEGIN{ORS=" "; OFS=" "} { print $1, $2, $3, $4, $5, $6}'`
if [ "$BEDresult" != "15_53040041_53040042_DEL_1 15 53040041 53040042 DEL full=3 " ]
then
...
squareResult=`$cut "./output/command_6_square-bracketed-ins_by_gridss.annotated.tsv" "AnnotSV_ID;ID;SV_chrom;SV_start;SV_end;SV_type;REF;ALT;ACMG_class" | grep -v "full=" | tail -1 | awk 'BEGIN{ORS=" "; OFS=" "} { print $1, $2, $3, $4, $5, $6, $7, $8, $9}'`
if [ "$squareResult" != "13_53040041_53040041_INS_1 ins_by_gridss 13 53040041 53040041 INS T TATATATATACACAC[13:53040042[ NA " ]
then
...
squareResult=`$cut "./output/command_8_square-bracketed-inv1.annotated.tsv" "AnnotSV_ID;ID;SV_chrom;SV_start;SV_end;SV_type;REF;ALT;ACMG_class" | tail -1 | awk 'BEGIN{ORS=" "; OFS=" "} { print $1, $2, $3, $4, $5, $6, $7, $8, $9}'`
if [ "$squareResult" != "3_2999_5000_INV_1 breakend_inv_1_a 3 2999 5000 INV T T]3:5000] NA " ]
then
...
angleResult=`$cut "./output/command_8_angle-bracketed-inv1.annotated.tsv" "AnnotSV_ID;ID;SV_chrom;SV_start;SV_end;SV_type;REF;ALT;ACMG_class" | tail -1 | awk 'BEGIN{ORS=" "; OFS=" "} { print $1, $2, $3, $4, $5, $6, $7, $8, $9}'`
if [ "$angleResult" != "3_2999_5000_INV_1 breakend_inv_1_a 3 2999 5000 INV T <INV> NA " ]
then
...
BEDresult=`$cut "./output/command_8_BED-inv1.annotated.tsv" "AnnotSV_ID;SV_chrom;SV_start;SV_end;SV_type;ACMG_class" | tail -1 | awk 'BEGIN{ORS=" "; OFS=" "} { print $1, $2, $3, $4, $5, $6}'`
if [ "$BEDresult" != "3_2999_5000_INV_1 3 2999 5000 INV NA " ]
then
...
squareResult=`$cut "./output/command_9_square-bracketed-inv2.annotated.tsv" "AnnotSV_ID;ID;SV_chrom;SV_start;SV_end;SV_type;REF;ALT;ACMG_class" | tail -1 | awk 'BEGIN{ORS=" "; OFS=" "} { print $1, $2, $3, $4, $5, $6, $7, $8, $9}'`
if [ "$squareResult" != "3_3000_5001_INV_1 breakend_inv_2_a 3 3000 5001 INV T [3:5001[T NA " ]
then
...
angleResult=`$cut "./output/command_9_angle-bracketed-inv2.annotated.tsv" "AnnotSV_ID;ID;SV_chrom;SV_start;SV_end;SV_type;REF;ALT;ACMG_class" | tail -1 | awk 'BEGIN{ORS=" "; OFS=" "} { print $1, $2, $3, $4, $5, $6, $7, $8, $9}'`
if [ "$angleResult" != "3_3000_5001_INV_1 breakend_inv_2_a 3 3000 5001 INV T <INV> NA " ]
then
...
squareResult=`$cut "./output/command_10_square-bracketed-inv3.annotated.tsv" "AnnotSV_ID;ID;SV_chrom;SV_start;SV_end;SV_type;REF;ALT;ACMG_class" | grep -v "full=" | tail -1 | awk 'BEGIN{ORS=" "; OFS=" "} { print $1, $2, $3, $4, $5, $6, $7, $8, $9}'`
if [ "$squareResult" != "1_7852191_9135238_INV_1 10_1 1 7852191 9135238 INV A A]1:9135238] NA " ]
then
...
squareResult=`$cut "./output/command_11_square-bracketed-tra1.annotated.tsv" "AnnotSV_ID;ID;SV_type;REF;ALT;ACMG_class" | grep -v "full=" | tail -2 | awk 'BEGIN{ORS=" "; OFS=" "} { print $1, $2, $3, $4, $5, $6}'`
if [ "$squareResult" != "13_123456_123456_TRA_1 tra_b TRA C C[2:321682[ NA 2_321682_321682_TRA_1 tra_a TRA T ]13:123456]T NA " ]
then
...
angleResult=`$cut "./output/command_11_angle-bracketed-tra1.annotated.tsv" "AnnotSV_ID;ID;SV_type;REF;ALT;ACMG_class" | grep -v "full=" | tail -2 | awk 'BEGIN{ORS=" "; OFS=" "} { print $1, $2, $3, $4, $5, $6}'`
if [ "$angleResult" != "13_123456_123456_TRA_1 tra_b TRA C <TRA>_2_123456 NA 2_321682_321682_TRA_1 tra_a TRA T <TRA>_13_321682 NA " ]
then
...
BEDresult=`$cut "./output/command_11_BED-tra1.annotated.tsv" "AnnotSV_ID;SV_type;ACMG_class" | grep -v "full=" | tail -2 | awk 'BEGIN{ORS=" "; OFS=" "} { print $1, $2, $3}'`
if [ "$BEDresult" != "13_123456_123456_TRA_1 TRA NA 2_321682_321682_TRA_1 TRA NA " ]
then
...
squareResult=`$cut "./output/command_12_square-bracketed-tra2.annotated.tsv" "AnnotSV_ID;ID;SV_type;REF;ALT;ACMG_class" | grep -v "full=" | tail -2 | awk 'BEGIN{ORS=" "; OFS=" "} { print $1, $2, $3, $4, $5, $6}'`
if [ "$squareResult" != "17_198982_198982_TRA_1 trn_no_mateid_a TRA A A]2:321681] NA 2_321681_321681_TRA_1 trn_no_mateid_b TRA G G]17:198982] NA " ]
then
...
angleResult=`$cut "./output/command_12_angle-bracketed-tra2.annotated.tsv" "AnnotSV_ID;ID;SV_type;REF;ALT;ACMG_class" | grep -v "full=" | tail -2 | awk 'BEGIN{ORS=" "; OFS=" "} { print $1, $2, $3, $4, $5, $6}'`
if [ "$angleResult" != "17_198982_198982_TRA_1 trn_no_mateid_a TRA A <TRA> NA 2_321681_321681_TRA_1 trn_no_mateid_b TRA G <TRA> NA " ]
then
