...
#         0.0927                  0.340   0.27    -2.65362022636097       1.0000e+00      1.0000e+00      0.9     1A (cf Gene_count, RE_gene, +0.00);2C-1 (DMD, +0.90);3A (1 gene, +0.00);5F (+0.00)      4
#         0.0927                          0.27    -2.65362022636097       1.0000e+00      1.0000e+00                      full=4
#         0.0237                  0.435   4.17    0.0512652381981393      9.9443e-01      9.9912e-01      0.15    1A (cf Gene_count, RE_gene, +0.00);2H (DIAPH2, +0.15);3A (1 gene, +0.00);5F (+0.00)     3
#         0.0237                          4.17    0.0512652381981393      9.9443e-01      9.9912e-01                      full=3
...
# B_gain_AFmax    B_loss_AFmax    B_ins_AFmax     B_inv_AFmax     GC_content_left DDD_HI_percent  ExAC_synZ       GnomAD_pLI      ExAC_pLI        AnnotSV_ranking_score   AnnotSV_ranking_criteria        ACMG_class
#         0,0927                  0,340   0,27    -2,65362022636097       1,0     1,0     0,9     1A (cf Gene_count, RE_gene, +0.00);2C-1 (DMD, +0.90);3A (1 gene, +0.00);5F (+0.00)      4
#         0,0927                          0,27    -2,65362022636097       1,0     1,0                     full=4
#         0,0237                  0,435   4,17    0,0512652381981393      0,99443 0,99912 0,15    1A (cf Gene_count, RE_gene, +0.00);2H (DIAPH2, +0.15);3A (1 gene, +0.00);5F (+0.00)     3
#         0,0237                          4,17    0,0512652381981393      0,99443 0,99912                 full=3
